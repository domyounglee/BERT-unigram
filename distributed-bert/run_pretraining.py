...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
                     ...
                     use_one_hot_embeddings,stage,prev_global_step):
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      train_op = optimization.create_optimizer(
          total_loss, learning_rate, num_train_steps, num_warmup_steps,stage,prev_global_step, use_tpu)
...
def main(_):
  ...
  if FLAGS.use_tpu:
        ...
        if FLAGS.multi_worker:
            ...
            run_config = tf.estimator.RunConfig(train_distribute=distribution,model_dir=FLAGS.output_dir,save_checkpoints_steps=FLAGS.save_checkpoints_steps)
  ...
  model_fn = model_fn_builder(
      ...
      prev_global_step=FLAGS.prev_global_step,
      stage=FLAGS.stage)
